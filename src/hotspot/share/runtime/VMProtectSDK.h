...
static inline void VMProtectBegin(const char*) { return; }
static inline void VMProtectBeginVirtualization( const char* ) { return; }
static inline void VMProtectBeginUltra(const char*) { return; }
static inline void VMProtectBeginMutation(const char*) { return; }
static inline void VMProtectEnd() { return; }
static inline bool VMProtectIsDebuggerPresent(bool) { return false; }
